...
% --- Заголовки нумерованных разделов ---
% parshape: первая строка с отступом, продолжение по левому краю
\titleformat{\section}[block]{\normalsize\bfseries}{}{0pt}{%
  \parshape 2 \parindent \dimexpr\linewidth-\parindent\relax 0pt \linewidth
...
% --- Заголовки ненумерованных разделов: по центру ---
\titleformat{name=\section,numberless}{\normalsize\bfseries\centering}{}{0em}{}
\titlespacing*{name=\section,numberless}{0pt}{2\baselineskip}{\baselineskip}
